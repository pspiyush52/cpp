...
*/
export class ExceptionBase : public std::exception{
    public:
...
*/
export class SizeError : public ExceptionBase{
    public:
...
*/
export class IndexError : public ExceptionBase{
    public:
...
*/
export class UndefinedError : public ExceptionBase{
    public:
...
Matrix& Matrix::operator+=(const Matrix& rhs){
    if (!this->is_dim_same(rhs))
        throw SizeError("Matrices must have the dimensions to be added.");
