...
int main(void)
{
    ...
    /* 
     * Inaccessible since public members of the base class become private in
    ...
    sep;
    /*
     * Not allowed since in private inheritance the public members of the
     * base become private in the derived class.
     *  
