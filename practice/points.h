...
class Point {
    public:
        ...
        */
        explicit operator double();  // type conversion can only be done as a member function
...
Point::operator double(){
    // std::cout << "conversion operator called... ";
    return (m_x + m_y) / 2;
}
...
template<typename T>
requires std::is_convertible_v<T, double>
inline Point operator*(T a, const Point& p){
